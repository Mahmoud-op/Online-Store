...
const purchaseButton = document.getElementById("danger");
purchaseButton.addEventListener("click", () => {
    // Show confirmation dialog
    const confirmPurchase = window.confirm("هل أنت متأكد أنك تريد تنفيذ عملية الشراء؟");

    if (confirmPurchase) {
        // If user confirms, hide all items and close the black screen
